...
extern "C"
{
     ...
     *
     * Call ClearWidgets & reinit ui to see tab changes
     */
    ...
    T_WRAPPER TReturnCode TAPI_ComboBox2(const char *label, int *current_item, const char *items[], int items_count, T_FUNC callback);
